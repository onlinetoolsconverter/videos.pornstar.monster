...
function sortByKey(e, t) {
    ...
    }, document.addEventListener("DOMContentLoaded", a), n.initEl = i, n.initAll = a;
    var r = n;
    return r
});
...
var dm = document.location.hostname.toLowerCase(),
	...
	/*Nulled by Imtiaj:
    Do "caesar cipher encryption base 13" of the full domain i.e www.pornstar.monster
	https://cryptii.com/pipes/caesar-cipher
	then reverse it i.e "ergfabz.engfaebc.jjj"
	*/
    doms = ["rivy.enzfz", "gfbuynpby", "rupnp", "ergfabz.engfaebc.jjj", "ylazuvt.yhazuyvw.liba", "ergfabz.engfaebc.fbrqvi"];
! function(e, t) {
    ...
    function n(t, s) {
        ...
        var c, u = t.id(),
            ...
            f = (i = t.$(".vjs-tech"), this),
            j = new Array,
            p = (new Array, new Array, new Array, !1);
        "" != a.shareUrl && (a.url = a.shareUrl), "" != a.shareTitle && (a.title = a.shareTitle), "" != a.shareEmbed && (a.embed = a.shareEmbed);
        ...
        if (!0 === p) {
            1 != e.browser.TOUCH_ENABLED ? document.body.classList.add("no-touch") : a.contextMenu = !1;
            try {
            ...
            if (vjs_find(r, ".vjs-quality-button").innerHTML = '<button class="vjs-quality-button vjs-menu-button vjs-menu-button-popup vjs-button"><span></span></button><div class="vjs-menu"><ul class="vjs-menu-content vjs-qlist" role="menu"></ul></div>', a.buttonForward) {
                ...
                x.el_.innerHTML = '<span aria-hidden="true" class="vjs-icon-placeholder"></span><span class="vjs-control-text" aria-live="polite">' + t.localize("Rewind") + "</span>", "party" == e.options.skinname && a.buttonRewind ? t.controlBar.el_.insertBefore(x.el_, vjs_find(r, ".vjs-rewind-control").nextSibling) : t.controlBar.el_.insertBefore(x.el_, t.controlBar.getChild("playToggle").el_.nextSibling), x.el_.onclick = function() {
                    k()
            ...
            var w = e.dom.createEl("div", {
                className: "vjs-vast-label"
            });
            w.innerHTML = t.localize("Advertisement"), "party" == e.options.skinname ? t.controlBar.el_.insertBefore(w, t.controlBar.getChild("currentTimeDisplay").el_) : t.controlBar.el_.insertBefore(w, t.controlBar.getChild("playToggle").el_.nextSibling);
            var T = t.controlBar.addChild("button", {
                el: e.dom.createEl("div", {
            ...
            t.controlBar.el_.insertBefore(T.el_, t.controlBar.getChild(y).el_);
            var E = vjs_find(r, ".vjs-cog-menu-button");
            if (a.theaterButton) {
                ...
                t.controlBar.el_.insertBefore(I.el_, t.controlBar.getChild("fullscreenToggle").el_), I.el_.innerHTML = "<span></span>", I.el_.addEventListener(setEvent("click"), function(e) {
            ...
            M.appendChild(P);
            var B = vjs_El("ul", "vjs-menu-content vjs-settings-list");
            P.appendChild(B), vjs_find(r, ".vjs-control-bar").appendChild(L), window.addEventListener("resize", function() {
                ne(), ae(), re();
            ...
            if ("" == a.title && (a.title = a.metatitle = document.title), "" == a.infoText && (a.infoText = a.metatitle), 1 != a.errordisplay && vjs_addClass(vjs_find(r, ".vjs-error-display"), "vjs-abs-hidden"), 1 != a.timetooltip) {
                var H = vjs_find(r, ".vjs-play-progress"),
                    D = vjs_find(H, ".vjs-time-tooltip");
                    ...
                    q.innerHTML = N, t.el().appendChild(q), r.addEventListener("contextmenu", function(t) {
                        ...
                        if (vjs_find(r, ".ctxt").onclick = function(e) {
                            ...
                            var o = r.getBoundingClientRect(),
                                d = n - o.top,
                                v = l - o.left;
                            d + i > r.offsetHeight && (d = r.offsetTop + r.offsetHeight - i), v + s > r.offsetWidth && (v = r.offsetWidth - s), q.style.top = d + "px", q.style.left = v + "px", e = setTimeout(function() {
                                vjs_addClass(q, "vjs-hidden")
            ...
            if (a.logo) {
                ...
                var R = vjs_El("div", "vjs-logo");
                r.appendChild(R), W.onload = function() {
                    if ("naturalHeight" in this) {
                        if (this.naturalHeight + this.naturalWidth === 0) return void r.removeChild(R)
                    } else if (this.width + this.height == 0) return void r.removeChild(R);
                    var e = a.logooffsetX;
                    a.logooffsetY;
                    if ("RT" == a.logoposition ? (R.style.right = e + "px", R.style.top = e + "px") : (R.style.left = e + "px", R.style.top = e + "px"), "" !== a.logourl) {
                        var t = vjs_El("a");
                        t.href = a.logourl, t.target = a.target, a.logotitle && t.setAttribute("title", a.logotitle), t.appendChild(W), R.appendChild(t), t.onclick = function(e) {
                            a.waslink = !1
                        }, t.ontouchstart = function(e) {
                            a.waslink = !1
                        }, R.style.cursor = "pointer"
                    } else R.appendChild(W)
                }, W.onerror = function() {
                    r.removeChild(R)
                }
            }
            if ("treso" == e.options.skinname) {
                var U = vjs_find(r, ".vjs-current-time"),
                    F = vjs_find(r, ".vjs-duration"),
                    Q = vjs_find(r, ".vjs-control-bar");
                Q.removeChild(U);
                var Y = vjs_find(r, ".vjs-progress-control");
                Y.insertBefore(U, Y.childNodes[0]), Q.removeChild(F), Y.appendChild(F)
            }
            t.resetNuevo = function(s) {
                ...
                if (1 == n.length && t.src(n), n.length > 1) {
                    var v = 0,
                        u = 0;
                    for (v = 0; v < n.length; v++)(n[v].res || n[v].label) && u++;
                    if (u >= a.minResolution) {
                        if (a.dash = !1, a.hls = !1, !t.src) {
                            var h = !1;
                            return (a.relatedMenu && related.length > 0 || a.shareMenu || a.rateMenu || a.zoomMenu) && (h = !0), 1 != h && vjs_find(r, ".vjs-cog-menu-button").vjs_addClass("vjs-hidden"), t.src()
                        }
                        var f, p = new Array,
                            m = new Array,
                            g = new Array,
                        ...
                        for ((Z = ["iPad", "iPhone", "iPod"].indexOf(navigator.platform) >= 0) && (T = !1), Z && 1 == o.length && (T = !0); b < o.length; b++) {
                            var E = "";
                            try {
                                D = o[b].type
                            } catch (e) {}
                            if ("" != D && (-1 === D.indexOf("mpeg") && -1 === D.indexOf("apple") || (a.hls = !0), -1 !== D.indexOf("dash") && (a.dash = !0)), o[b].res && o[b].label) {
                                1 != w && (w = !0, f = {
                                    res: o[b].res,
                                    type: o[b].type,
                                    src: o[b].src,
                                ...
                                E = o[b].type;
                                if (o[b].default);
                                else; - 1 !== E.indexOf("mpeg") || -1 !== E.indexOf("apple") ? (p[C] = o[b], ++C > 1 && (a.hls = !0, a.hlsQualities = !1)) : -1 !== E.indexOf("dash") ? (m[A] = o[b], ++A > 1 && (a.dash = !0, a.dashQualities = !1)) : (g[x] = o[b], x++)
                            }
                        }
                        var I = new Array;
                        I = (I = p.length > 0 && T ? p : m.length > 0 && T ? m : g).sort(oe);
                        var L = "",
                            M = " vjs-checked";
                        L = ' class="item-quality"', M = ' class="item-quality vjs-checked"';
                        for (b = 0; b < I.length; b++) {
                            ...
                            if (a.hdicon) {
                                var z = "HD";
                                B > 1079 && (z = "FullHD"), B > 2159 && (z = "4K"), B > 719 && (H = '<i class="vjs-hd-icon">' + z + "</i>")
                            }
                            0 == b && " vjs-first", I[b].default ? (i = I[b], _ += "<li" + M + ' data-res="' + b + '">' + I[b].label + H + "</li>", y += '<li class="quality-full vjs-checked" data-res="' + b + '">' + I[b].label + H + "</li>") : (_ += "<li" + L + ' data-res="' + b + '">' + I[b].label + H + "</li>", y += '<li class="quality-full" data-res="' + b + '">' + I[b].label + H + "</li>"), k++
                        }
                        if (k > 1) {
                            var S = vjs_El("div", "vjs-back-res vjs-hidden"),
                                q = '<div class="vjs-res-header">' + t.localize("Quality") + '<div class="vjs-close-btn"></div></div>';
                            S.innerHTML = q;
                            var N = vjs_El("div", "vjs-res-block");
                            S.appendChild(N);
                            var O = vjs_El("ul");
                            if (N.appendChild(O), O.innerHTML = y, r.appendChild(S), vjs_find(r, ".vjs-back-res .vjs-res-header .vjs-close-btn").onclick = function() {
                                    ...
                                    vjs_addClass(vjs_find(r, ".vjs-back-res"), "vjs-hidden")
                                }, l = k, a.res_num = k, a.qualityMenu) {
                                var W = '<li class="vjs-settings-item vjs-extend-quality vjs-menu-forward">' + t.localize("Quality") + "<span></span></li>",
                                    R = vjs_El("div", "vjs-submenu vjs-menu-quality vjs-hidden");
                                R.innerHTML = '<ul class="vjs-menu-content"><li class="vjs-settings-back vjs-quality-back">Quality</li></ul><ul class="vjs-menu-content vjs-qua-list">' + _ + "</ul>", vjs_find(r, ".vjs-settings-list").innerHTML += W, vjs_find(r, ".vjs-settings-div").appendChild(R);
                                var U = vjs_mfind(r, ".item-quality")
                            } else vjs_find(r, ".vjs-quality-button .vjs-menu .vjs-menu-content").innerHTML = _, vjs_remClass(vjs_find(r, ".vjs-quality-button"), "vjs-hidden");
                            U = vjs_mfind(r, ".item-quality");
                            var F = vjs_mfind(r, ".quality-full");
                            re(), a.menutouch = !1;
                            for (b = 0; b < U.length; b++) {
                                ...
                                var K = function(e) {
                                    var s;
                                    e.preventDefault(), e.stopPropagation();
                                    for (var i = 0; i < U.length; i++) vjs_remClass(U[i], "vjs-checked"), vjs_remClass(F[i], "vjs-checked"), U[i] != e.target && F[i] != e.target || (s = i);
                                    vjs_addClass(U[s], "vjs-checked"), vjs_addClass(F[s], "vjs-checked");
                                    var n = e.target.getAttribute("data-res");
                                    le(I[n].res, I[n].label);
                                    var a = I[n];
                                    t.trigger("resolutionchange", {
                                        label: I[n].label,
                                        res: I[n].res
                                    }), vjs_addClass(vjs_find(r, ".vjs-back-res"), "vjs-hidden"), X(a)
                                };
                            ...
                            }(1 != a.hls && 1 != a.dash || 1 != T) && le(f.res, f.label), p.length > 1 && 1 != a.hlsQualities && T && le(f.res, f.label), m.length > 1 && 1 != a.dashQualities && T && le(f.res, f.label), ie(), void 0 !== i || void 0 !== f ? (1 != a.hls && 1 != a.dash || 1 != T || p.length > 1 && 1 != a.hlsQualities && T || m.length > 1 && 1 != a.dashQualities && T) && (void 0 !== i && i != f ? (le(i.res, i.label), t.src(i), t.load()) : void 0 !== f && (le(f.res, f.label), t.src(f), t.load())) : (p.length > 1 && T || m.length > 1 && T) && le("auto", "Auto")
                        }
                    }
                }
                var Z;
                T = "MediaSource" in window;
                (Z = ["iPad", "iPhone", "iPod"].indexOf(navigator.platform) >= 0) && !0;
                if (t.on("loadeddata", function() {
                        if (a.chapterMarkers) {
                            ...
                            if (s.length > 0)
                                for (var i = 0; i < s.length; i++)
                                    if ("chapters" == s[i].kind && 1 != e) {
                                        e = !0;
                                        var n = s[i]
                                    } if (n) {
                                vjs_addClass(vjs_find(r, ".vjs-mouse-display"), "vjs-abs-hidden");
                                var o = n.cues,
                                    d = [],
                                    v = vjs_find(r, ".vjs-progress-holder"),
                                    u = t.duration();
                                for (i = 0; i < o.length; i++)
                                    if (o[i].startTime > 0) {
                                        d[i] = o[i].startTime;
                                        var h = vjs_El("div", "vjs-marker"),
                                            f = vjs_El("div", "vjs-marker-inn"),
                                            p = vjs_El("div", "vjs-marker-tooltip");
                                        h.appendChild(f), h.appendChild(p), p.innerHTML = o[i].text, h.style.left = d[i] / u * 100 + "%", v.appendChild(h), h.onmouseenter = function() {
                                            var e = this.offsetLeft,
                                                t = vjs_find(this, ".vjs-marker-tooltip"),
                                                s = t.offsetWidth / 2,
                                                i = vjs_find(r, ".vjs-progress-control"),
                                                n = (i.offsetLeft, i.offsetWidth),
                                                a = -1 * e + s,
                                                l = t.offsetWidth / 2 * -1 + (n - e);
                                            e - s < 0 ? t.style.left = a + "px" : e + s > n ? t.style.left = l + "px" : t.removeAttribute("style")
                                        }
                                    }
                            }
                        }
                        ...
                        if (T && 1 != Z) try {
                            ...
                            var y = t.dash.mediaPlayer.getBitrateInfoListFor("video"),
                                b = t.dash.mediaPlayer.getQualityFor("video");
                            i = 0;
                            y.length > 1 && a.dashQualities && (t.dash.mediaPlayer.setAutoSwitchQualityFor("video", !0), y.forEach(function(e) {
                                var t = new Object;
                                "video" == e.mediaType && (e.height > 0 || e.bitrate > 0) && (t.id = i, e.height > 0 ? t.height = e.height : t.height = 0, e.bitrate > 0 ? t.bitrate = parseInt(e.bitrate / 1e3) : t.bitrateh = 0, i == b ? (t.auto = 1, g = !0, e.height > 0 && (_ = e.height), e.bitrate > 0 && parseInt(e.bitrate / 1e3)) : t.auto = 0, m.push(t), c = "dash"), i += 1
                            }))
                        } catch (e) {}
                        if (T && 1 != Z) try {
                            t.tech_.hls.representations().forEach(function(e) {
                                ...
                                (e.height > 0 || e.bandwidth > 0) && (s.auto = 0, e.bandwidth && e.bandwidth > 0 && (s.bitrate = parseInt(e.bandwidth / 1e3), i.attributes.BANDWIDTH == e.bandwidth && (s.auto = 1, g = !0, _ = e.height, e.bandwidth)), s.id = e.id, s.height = e.height, m.push(s), c = "hls")
                            })
                        } catch (e) {}
                        m.length > 0 && (ee(), l = m.length, !0, !0, j = m, function(e, s, i, n) {
                            if (j.length < 2) ee();
                            else {
                                for (var l = !0, o = 0, d = 0, v = !1, c = 0, u = j.length; c < u; c++)
                                    if (j[c].height > 0 && o++, j[c].bitrate > 0 && d++, j[c].duplicate = !1, j[c].height > 0 && 1 != v) {
                                        var h = 0,
                                            f = 0;
                                        for (u = j.length; f < u; f++) j[c].height == j[f].height && h++;
                                        h > 1 && (v = !0)
                                    } var p = "bitrate";
                                o > d && (p = "height"), j = (j = sortByKey(j, p)).reverse(), L = "item-quality", M = "item-quality vjs-checked";
                                var m = "",
                                    g = "";
                                ...
                                _.appendChild(y), O = vjs_El("ul"), y.appendChild(O);
                                var b, C = new Array,
                                    A = new Array,
                                    x = new Array;
                                for (c = 0, u = j.length; c < u; c++) {
                                    ...
                                    if (a.hdicon) {
                                        var T = "HD";
                                        w > 1079 && (T = "FullHD"), w > 2159 && (T = "4K"), w > 719 && (k = '<i class="vjs-hd-icon">' + T + "</i>")
                                    }
                                    var E = 0;
                                    if (E = "dash" == e ? j[c].id : j[c].bitrate, j[c].height > 0 || j[c].bitrate > 0) {
                                        var I = L,
                                            P = "full-quality";
                                        if (v) {
                                            var B = j[c].height.toString() + "-" + j[c].bitrate.toString();
                                            j[c].height > 0 && j[c].bitrate > 0 && d == o ? (vjs_inArray(B, x) > -1 && (I = L + " vjs-hidden", P = "full-quality vjs-hidden"), m += '<li class="' + I + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p <i>(" + j[c].bitrate + " kbps)</i></li>", g += '<li class="' + P + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p <i>(" + j[c].bitrate + " kbps)</i></li>") : j[c].height > 0 && o > d ? (vjs_inArray(j[c].height, C) > -1 && (I += " vjs-hidden", P += " vjs-hidden"), m += '<li class="' + I + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p</li>", g += '<li class="' + P + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p</li>") : (vjs_inArray(j[c].bitrate, A) > -1 && (I += " vjs-hidden", P += " vjs-hidden"), m += '<li class="' + cls11 + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].bitrate + "kbps</li>", g += '<li class="' + P + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].bitrate + "kbps</li>")
                                        } else j[c].bitrate > 0 && d > o ? (vjs_inArray(j[c].bitrate, A) > -1 && (I += " vjs-hidden", P += " vjs-hidden"), m += '<li class="' + I + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].bitrate + " kbps</li>", g += '<li class="' + P + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].bitrate + " kbps</li>") : (vjs_inArray(j[c].height, C) > -1 && (I += " vjs-hidden", P += " vjs-hidden"), m += '<li class="' + I + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p" + k + "</li>", g += '<li class="' + P + '" data-id="' + E + '" data-bit="' + j[c].bitrate + '" data-res="' + j[c].height + '" role="menuitem" aria-live="polite" aria-disabled="false">' + j[c].height + "p" + k + "</li>")
                                    }
                                    A.push(j[c].bitrate), C.push(j[c].height), b = j[c].height ? j[c].height.toString() + "-" + j[c].bitrate.toString() : j[c].bitrate.toString(), x.push(b)
                                }
                                s && (m += '<li class="item-quality" data-id="Autores" data-res="Autores"' + M + ' role="menuitem" aria-live="polite" aria-disabled="false">Auto', g += '<li class="full-quality" data-id="Autores_full" data-res="Autores"full-quality vjs-checked role="menuitem" aria-live="polite" aria-disabled="false">Auto', "hls" == e && i && (m += '<i class="autores">' + i + "p</i>", g += '<i class="autores2">' + i + "p</i>"), m += "</li>"), O.innerHTML = g, r.appendChild(_);
                                var H = vjs_find(r, ".vjs-back-res .vjs-res-header .vjs-close-btn");
                                ...
                                var S = vjs_mfind(r, ".item-quality"),
                                    q = vjs_mfind(r, ".full-quality");
                                for (le("auto", "Auto"), ie(), a.menutouch = !1, re(), c = 0; c < S.length; c++) {
                                    Q = S[c], Y = q[c];
                                    var N = function(s) {
                                        var i;
                                        s.preventDefault(), s.stopPropagation();
                                        for (var n = S, a = q, o = 0; o < S.length; o++) vjs_remClass(q[o], "vjs-checked"), vjs_remClass(S[o], "vjs-checked"), S[o] == s.target && (i = o), q[o] == s.target && (i = o);
                                        ...
                                        if (vjs_find(r, ".vjs-quality-button .vjs-menu").style.display = "none", vjs_addClass(vjs_find(r, ".vjs-back-res"), "vjs-hidden"), "dash" == e) {
                                            ...
                                            if (v == c || parseInt(e.bandwidth / 1e3) == parseInt(v)) {
                                                var s = parseInt(e.bandwidth / 1e3),
                                                    i = parseInt(v);
                                                e.enabled(!0), e.height == c ? le(c, c + "p") : s == i && le(c, parseInt(e.bandwidth / 1e3) + " kbps"), W("Auto"), t.trigger("resolutionchange", {
                                                    label: c + "p",
                                                    res: c
                                                })
                                            } else e.enabled(!1)
                                    ...
                                    function W(e) {
                                        "Auto" == e && (e = "");
                                        try {
                                            vjs_find(r, ".autores").innerHTML = e
                                        } catch (e) {}
                                        try {
                                            vjs_find(r, ".autores2").innerHTML = e
                                        } catch (e) {}
                                    }
                                                ...
                                                t.tech_.hls.representations().forEach(function(e) {
                                                    if (parseInt(s.attributes.BANDWIDTH) == parseInt(e.bandwidth))
                                                        if (e.height > 0) {
                                                            ...
                                                            1 != a.qualityMenu ? vjs_find(r, ".vjs-quality-button span").innerHTML = t ? 'Auto<i class="vjs-hd-icon vjs-hd-home">' + i + "</i>" : "Auto" : vjs_find(r, ".vjs-extend-quality span").innerHTML = t ? 'Auto<i class="vjs-hd-icon vjs-hd-menu">' + i + "</i>" : "Auto", W(e.height + "p")
                                                        } else e.bandwith > 0 && W(parseInt(e.bandwidth / 1e3) + "kbps")
                                                })
                                            }
                                        } else W("Auto")
                                    }), Y.className.indexOf("vjs-hidden") < 0 && (Y.onclick = function(e) {
                                        N(e)
                                    }, Y.ontouchend = function(e) {
                                        N(e)
                                    }), Q.className.indexOf("vjs-hidden") < 0 && (Q.ontouchend = function(e) {
                                        N(e)
                                    }, Q.onclick = function(e) {
                                        N(e)
                                    })
                    ...
                    var J, G = vjs_find(r, ".vjs-play-progress");
                    (J = vjs_find(G, ".vjs-time-tooltip")) && (J.className = "vjs-time-tooltip")
                }
                a.mousedisplay && ((J = vjs_find(r, ".vjs-mouse-display")) && (J.className = "vjs-mouse-display"));
                var V = vjs_find(r, ".vjs-info");
                if (0 != a.videoInfo && ("" != a.infoText || "" != a.title)) {
                    var $ = !1,
                        te = a.url || document.location.href,
                        se = vjs_El("span", "vjs-info"),
                        ne = "";
                    ne = "" != a.infoText ? a.infoText : "" != a.metatitle ? a.metatitle : a.title;
                    var ae = a.infoSize;
                    parseInt(a.infoSize) > 15 && parseInt(a.infoSize) < 24 && (ae = 18);
                    var de = "color:#fff;font-size:" + ae + "px;";
                    a.infoBold && (de += "font-weight:bold;"), "" != a.infoFont ? de += "font-family:" + a.infoFont : de += "font-family:sans-serif", se.style = de, "" != a.infoIcon && (ve = '<img src="' + a.infoIcon + '"/>', "" != a.infoIconURL && (ve = '<a target="' + a.target + '" href=' + a.infoIconURL + ">" + ve + "</a>", ne = '<a style="' + de + '" href="' + te + '" target="' + a.target + '">' + ne + "</a>", $ = !0), "right" != a.infoAlign ? ne = ve + ne : ne += ve), 1 != $ && (ne = '<a style="' + de + '" href="' + te + '" target="' + a.target + '">' + ne + "</a>"), se.innerHTML = ne, V ? V.parentNode.replaceChild(se, V) : r.appendChild(se), "right" == a.infoAlign && (se.style.textAlign = "right");
                    var ve = "";
                    se.onclick = function() {
                        window.open(te, a.target), a.waslink = !0
                    }, se.ontouchstart = function() {
                        window.open(te, a.target), a.waslink = !0
                    }
                }
            };
            ...
            if ((X = t.options_.sources).length > 0) {
                ...
                } catch (e) {} - 1 !== D.indexOf("dash") && K && t.src(X), t.resetNuevo(!1), de()
            } else t.resetNuevo(!1), de();
            if (t.reconnect = function() {
                    var e = t.src();
                    t.reset(), t.src(e), t.load(), t.resetNuevo(!0), t.play()
                }, t.showRelated = function() {
                    a.related.length > 1 && a.relatedMenu && 1 != t.seeking() && (a.waslink = !1, vjs_addClass(vjs_find(r, ".vjs-menu-settings"), "vjs-hidden"), vjs_addClass(_, "vjs-hidden"), vjs_remClass(vjs_find(r, ".vjs-grid"), "vjs-hidden"), ne(), a.isAddon = !0, t.pause())
                    ...
                    if (a.title = "", a.metatitle = "", a.metasubtitle = "", e) {
                        if ("string" == typeof e) e = {
                            sources: [{
                                src: e
                            }]
                        ...
                        if (e.sources) {
                            for (void 0 !== e.slideImage ? a.slideImage = e.slideImage : a.slideImage = "", void 0 !== e.poster && (r.setAttribute("poster", e.poster), vjs_find(r, ".vjs-tech").setAttribute("poster", e.poster)), ve(), void 0 !== e.title && (a.metatitle = a.title = e.title), void 0 !== e.shareTitle && (a.metatitle = a.title = e.shareTitle), void 0 !== e.metatitle && (a.metatitle = e.metatitle), void 0 !== e.subtitle && (a.metasubtitle = e.subtitle), void 0 !== e.metasubtitle && (a.metasubtitle = e.metasubtitle), s = 0; s < e.sources.length; s++) e.sources[s].metatitle || e.sources[s].title || (e.sources[s].metatitle = a.metatitle), !e.sources[s].metatitle && e.sources[s].title && (e.sources[s].metatitle = e.sources[s].title), e.sources[s].metasubtitle || e.sources[s].subtitle || (e.sources[s].metasubtitle = a.metasubtitle), !e.sources[s].metasubtitle && e.sources[s].subtitle && (e.sources[s].metasubtitle = e.sources[s].subtitle);
                            for (var s = (l = t.remoteTextTracks()) && l.length || 0; s--;) t.removeRemoteTextTrack(l[s]);
                            var i = t.videoTracks();
                            ...
                            if (t.options_.sources = e.sources, t.captions = null, void 0 !== e.tracks) {
                                var l = e.tracks;
                                for (s = 0; s < l.length; s++)(l[s].src = "captions" == l[s].kind) && (l[s].default && (l[s].mode = "showing"), l[s].language = l[s].srclang);
                                l.length > 0 && (t.captions = l)
                            }
                            if ("video/mp4" != e.sources[0].type && e.sources[0].type, t.resetNuevo(!0, e), void 0 !== e.tracks)
                                for (l = e.tracks, s = 0; s < l.length; s++) "undefined" != l[s].src && (l[s].default && (l[s].mode = "showing", t.currentTrack = l[s].src), t.addRemoteTextTrack(l[s], !1));
                            else void 0 !== e.track && "undefined" != track.src && (e.track.mode = "showing", t.addRemoteTextTrack(e.track, !1));
                            a.infoText = a.metatitle, void 0 !== e.url && (a.url = e.url)
                        }
                    }
                }, t.on("playlistready", function() {
                    a.playlistRepeat && t.playlist.repeat(!0),
                        function() {
                            if ((h = t.playlist.list()).length < 2) return;
                            t.playlist.repeat();
                            if (1 != a.playlist) {
                                ...
                                if (a.playlistUI) {
                                    ...
                                    var h = t.playlist.list(),
                                        f = 0,
                                        j = 0;
                                    for (f = 0; f < h.length; f++) {
                                        var p = vjs_El("div", "vjs-item");
                                        p.setAttribute("data-id", f);
                                        var m = vjs_El("div", "vjs-tmb");
                                        h[f].thumb ? m.style.backgroundImage = "url(" + h[f].thumb + ")" : h[f].poster && (m.style.backgroundImage = "url(" + h[f].poster + ")"), p.appendChild(m);
                                        var g = vjs_El("p");
                                        if (h[f].title) g.innerHTML = h[f].title;
                                        else {
                                            var _ = h[f].sources[0].src,
                                                y = _.substring(_.lastIndexOf("/") + 1);
                                            if (h[f].sources.length > 0)
                                                for (j = 0; j < h[f].sources.length; j++)
                                                    if (h[f].sources[j].default) {
                                                        var _ = h[f].sources[j].src;
                                                        y = _.substring(_.lastIndexOf("/") + 1)
                                                    } y = y.replace(/(\.[^/.]+)+$/, ""), g.innerHTML = y
                                        }
                                        if (p.appendChild(g), h[f].duration) {
                                            var b = vjs_El("span");
                                            b.innerHTML = h[f].duration, p.appendChild(b)
                                        }
                    ...
                    function l(e) {
                        a.isAddon && (a.isAddon = !1, vjs_addClass(vjs_find(r, ".vjs-grid"), "vjs-hidden"), vjs_addClass(vjs_find(r, ".vjs-sharing-overlay"), "vjs-hidden"), vjs_remClass(_, "vjs-hidden"), a.isAddon = !1, f.pauseLock = !1, 1 != a.waslink ? 1 == a.player_state && 3 != a.newstate || t.play() : (t.pause(), a.waslink = !1));
                        ...
                        try {
                            vjs_find(r, ".vjs-quality-button .vjs-menu").style.display = "none"
                        } catch (e) {}
                        try {
                            vjs_find(r, ".vjs-menu").style.display = "none"
                        } catch (e) {}
                    }
                    ...
                    var c = vjs_find(r, ".vjs-progress-holder");
                    c.addEventListener(setEvent("mousedown"), function(e) {
                    ...
                    }, !1), c.addEventListener(setEvent("mouseup"), function(e) {
                    ...
                    function p() {
                        if (a.resume && "" != a.video_id && localStorage && localStorage.vjs_resume) {
                            var e = localStorage.vjs_resume.split(",");
                            if (2 == e.length)
                                if (e[0] == a.video_id && Number(e[1]) > 3) {
                                    var s = Number(e[1]);
                                    setTimeout(function() {
                                        fe("vjs_resume", a.video_id + ",0"), t.currentTime(s)
                                    }, 500)
                                }
                        }
                    }
                    t.on("useractive", function() {
                        ...
                        if (!h) {
                            h = !0, ve(), 1 != e.browser.IS_IOS && p();
                            try {
                                vjs_find(r, "video").controls = !1
                            } catch (e) {}
                            if (a.limit > 0 && ("" != a.limiturl || "" != a.url)) {
                                var s = !1;
                                t.on("timeupdate", function() {
                                    if (t.currentTime() > a.limit && (t.pause(), _.style.display = "none", 1 != s)) {
                                        s = !0;
                                        var e = vjs_El("div", "vjs-limit-overlay"),
                                            i = vjs_El("a", "vjs-limit");
                                        if (i.href = a.limiturl, i.target = a.target, i.style.textDecoration = "none", e.appendChild(i), i.onclick = function(e) {
                                                a.waslink = !0
                                            }, i.ontouchstart = function(e) {
                                                a.waslink = !0
                                            }, "" == a.limiturl && (a.limiturl = a.url), "" != a.limitimage) {
                                            var n = vjs_El("img");
                                            n.src = a.limitimage, n.onload = function() {
                                                i.innerHTML = '<img style="max-width:100%;height:auto;" src="' + a.limitimage + '" />'
                                            }, n.onerror = function() {
                                                r()
                                            }
                                        } else r();
                                        ...
                                        function r() {
                                            ...
                                            e.innerHTML = t + '<span style="color:#fff;">' + a.limiturl + "</span>", i.appendChild(e)
                                        }
                                        t.el().appendChild(e)
                                    }
                                })
                            ...
                            var i = !1;
                            if ((a.relatedMenu || a.shareMenu || a.rateMenu || a.zoomMenu) && (i = !0), i) {
                                var n = "",
                                    l = !1,
                                    c = !1;
                                if (a.shareMenu && (n = n + '<li class="vjs-settings-item vjs-share-button">' + t.localize("Share") + '<span class="vjs-share-icon"></span></li>'), a.relatedMenu && a.related.length > 1 && (n = n + '<li class="vjs-settings-item vjs-related-button">' + t.localize("Related") + '<span class="vjs-related-icon"></span></li>'), a.zoomMenu) {
                                    n = n + '<li class="vjs-settings-item vjs-extend-zoom vjs-menu-forward">' + t.localize("Zoom") + '<span class="zoom-label">100%</span></li>';
                                    c = vjs_El("div", "vjs-submenu vjs-zoom-menu vjs-hidden", '<div class="vjs-settings-back vjs-zoom-return"><span>' + t.localize("Zoom") + '</span></div><div class="vjs-zoom-slider"><div class="vjs-zoom-back"></div><div class="vjs-zoom-level"></div></div><div class="vjs-zoom-reset">RESET</div>')
                                }
                                if (a.rateMenu) {
                                    n = n + '<li class="vjs-settings-item vjs-extend-speed vjs-menu-forward">' + t.localize("Speed") + "<span>Normal</span></li>";
                                ...
                                var u = vjs_find(r, ".vjs-settings-list");
                                if ("" != n) {
                                    n += "", u.innerHTML = n + u.innerHTML, l && vjs_find(r, ".vjs-settings-div").appendChild(l), c && vjs_find(r, ".vjs-settings-div").appendChild(c), vjs_remClass(vjs_find(r, ".vjs-cog-menu-button"), "vjs-hidden"), ie(), re();
                                    for (var j = function(e) {
                                        ...
                                        }, m = r.querySelectorAll(".vjs-speed"), g = 0; g < m.length; g++) m[g].addEventListener("click", j, !0), m[g].addEventListener("touchstart", j, !0)
                                }
                                if (a.related.length > 1 && a.relatedMenu) {
                                    ...
                                    var x = vjs_El("p");
                                    x.innerHTML = t.localize("Related videos");
                                    var k = vjs_El("div", "vjs-related");
                                    C && (k.className = "vjs-related vjs-scroll");
                                    var w = r.offsetWidth,
                                        T = .8 * w;
                                    if (C && (T = .9 * w), b.appendChild(x), b.appendChild(k), r.appendChild(b), 1 != C) {
                                        var E = parseInt(vjs_find(r, ".vjs-prev").offsetWidth) + 5;
                                        vjs_find(r, ".vjs-arrow-prev").style.left = parseInt(k.style.left) - E + "px", vjs_find(r, ".vjs-arrow-next").style.left = T + parseInt(k.style.left) + "px"
                                    }
                                    var I = vjs_El("div", "rel-block rel-anim");
                                    k.appendChild(I);
                                    var L = a.related;
                                    o = 1;
                                    for (g = 0; g < y; g++) {
                                        ...
                                        M.appendChild(P), I.appendChild(M), P.innerHTML = '<a class="rel-url" target="' + a.target + '" href="' + L[g].url + '" alt="' + L[g].title + '"><span class="rel-bg" style="background-image:url(' + L[g].thumb + ');"></span><label>' + L[g].title + "</label><i>" + L[g].duration + "</i></a>"
                                    }
                                    var B = vjs_mfind(r, ".rel-url");
                                    for (g = 0; g < B.length; g++) B[g].onclick = function(e) {
                                        a.waslink = !0
                                    };
                                    ...
                                    1 != C && (vjs_find(r, ".vjs-arrow-prev").onclick = function(e) {
                                        ...
                                        e.preventDefault(), e.stopImmediatePropagation(), t.showRelated()
                                ...
                                if (a.shareMenu) {
                                    var z = vjs_El("div", "vjs-sharing-overlay vjs-hidden"),
                                        ...
                                        q = vjs_El("div", "vjs-sharing-body"),
                                        N = a.url || document.location.href,
                                        O = a.embed || "N/A",
                                    ...
                                    R += '<div class="vjs-share-block"><i title="Facebook" id="share_facebook" class="vjs-share-icon nv vjs-facebook-square" role="button" aria-live="polite" tabindex="0"></i>', R += '<i title="Twitter" id="share_twitter" class="vjs-share-icon nv vjs-twitter-square" role="button" aria-live="polite" tabindex="0"></i>', R += '<i title="Pinterest" id="share_pinterest" class="vjs-share-icon nv vjs-pinterest-square" role="button" aria-live="polite" tabindex="0"></i>', R += '<i title="LinkedIn" id="share_linkedin" class="vjs-share-icon nv vjs-linkedin-square" role="button" aria-live="polite" tabindex="0"></i></div>', q.innerHTML = R, S.appendChild(q), z.appendChild(W), z.appendChild(S), t.el().appendChild(z), vjs_find(r, ".embed-code").value = O, vjs_find(r, ".perma").value = N, vjs_find(r, ".vjs-share-button").addEventListener(setEvent("click"), function(e) {
                                        e.preventDefault(), e.stopImmediatePropagation(), vjs_addClass(vjs_find(r, ".vjs-menu-settings"), "vjs-hidden"), vjs_remClass(z, "vjs-hidden"), f.pauseLock = !0, vjs_addClass(_, "vjs-hidden"), a.isAddon = !0;
                                        var s = t.paused();
                                        a.player_state = s, 1 != s && t.pause()
                                    }, !1);
                                    var U = {
                                            url: N,
                                            title: a.metatitle || a.title || document.title,
                                            description: t.localize("Check out this cool video on") + " " + a.url,
                                            pubid: a.pubid || null
                                        },
                                        F = function(e) {
                                            e.preventDefault(), e.stopImmediatePropagation();
                                            ...
                                            window.open("http://api.addthis.com/oexchange/0.8/forward/" + t + "/offer?" + function(e) {
                                                ...
                                                return t.join("&")
                                            }(U), "AddThis", "height=450,width=550,modal=yes,alwaysRaised=yes")
                                        },
                                        Q = r.querySelectorAll(".vjs-share-icon");
                                    for (g = 0; g < Q.length; g++) Q[g].addEventListener("click", F, !1);

                                    function Y() {
                                        a.isAddon = !1, vjs_addClass(vjs_find(r, ".vjs-sharing-overlay"), "vjs-hidden"), vjs_addClass(_, "vjs-hidden"), a.isAddon = !1, f.pauseLock = !1, 1 == a.player_state && 3 != a.newstate || t.play()
                                    }
                                ...
                                if (a.zoomMenu) {
                                    ...
                                    if (vjs_remClass(J, "vjs-hidden"), J.setAttribute("style", ""), J.style.display = "inline-block", J.style.opacity = 0, e.browser.TOUCH_ENABLED && (vjs_find(r, ".vjs-tech").style.pointerEvents = "none"), a.zoomInfo) {
                                        var G = vjs_El("div", "vjs-zoom-parent vjs-hidden"),
                                            V = vjs_El("div", "vjs-reset-zoom");
                                        V.innerHTML = t.localize("100%"), G.appendChild(V);
                                        var $ = vjs_El("div", "vjs-reset-center"),
                                            ee = vjs_El("div", "vjs-reset-cancel");
                                        G.appendChild($), G.appendChild(ee);
                                        var te = vjs_El("div", "vjs-reset-info");
                                        G.appendChild(te);
                                        var ne = vjs_El("div", "vjs-zoom-help vjs-hidden");

                                        function ae(e) {
                                            e.preventDefault(), e.stopPropagation(), vjs_hasClass(ne, "vjs-hidden") ? (vjs_remClass(ne, "vjs-hidden"), vjs_addClass(_, "vjs-hidden")) : (vjs_addClass(ne, "vjs-hidden"), vjs_remClass(_, "vjs-hidden"))
                                        }

                                        function le() {
                                            vjs_addClass(ne, "vjs-hidden"), vjs_remClass(_, "vjs-hidden")
                                        }
                                        a.zoomWheel ? ne.innerHTML = '<div class="zoom-close">x</div><div>' + t.localize("ZOOM HELP") + "</div>" + t.localize("Use ZOOM slider or mouse wheel to ZOOM in video.") + "<div>" + t.localize("Drag zoomed area using your mouse or a finger.") + "</div>" : ne.innerHTML = '<div class="zoom-close">x</div><div>' + t.localize("ZOOM HELP") + "</div>" + t.localize("Drag zoomed area using your mouse or a finger.") + "</div>", G.appendChild(te), te.onmouseup = function(e) {
                                            ae(e)
                                        }, te.ontouchend = function(e) {
                                            ae(e)
                                        }, vjs_find(ne, ".zoom-close").onmouseup = function() {
                                            le()
                                        }, vjs_find(ne, ".zoom-close").ontouchend = function() {
                                            le()
                                        }, r.appendChild(ne), ee.onmouseup = function() {
                                            ue()
                                    ...
                                    vjs_find(r, ".vjs-zoom-reset").addEventListener("mouseup", ue, !1), vjs_find(r, ".vjs-zoom-reset").addEventListener("touchend", ue, !1);
                                    var oe = t.el();
                                    if (oe.hasAttribute("tabIndex") || oe.setAttribute("tabIndex", "-1"), oe.style.outline = "none", a.zoomWheel) {
                                        if (e.browser.TOUCH_ENABLED) {
                                            var de = vjs_El("div", "vjs-zoom-slide"),
                                                fe = vjs_El("div", "zoom-bg"),
                                                ge = vjs_El("div", "zoom-thumb");
                                            de.appendChild(fe), de.appendChild(ge), r.appendChild(de), de.style.height = r.offsetHeight - 85 + "px", window.addEventListener("resize", function(e) {
                                                de.style.height = r.offsetHeight - 85 + "px", he()
                                            }, !1), de.addEventListener("touchstart", function(e) {
                                                e.preventDefault(), e.stopPropagation(), pe(), vjs_addClass(de, "vjs-slide-block");
                                                var t = function(e) {
                                                        e.preventDefault(), e.stopPropagation(), Ae(e, de)
                                                    },
                                                    s = function(e) {
                                                        e.preventDefault(), e.stopPropagation(), me(), setTimeout(function() {
                                                            vjs_remClass(de, "vjs-slide-block")
                                        ...
                                        function _e(e) {
                                            ...
                                            (v = (100 * v + t) / 100) < 1 && (v = 1), v > 5 && (v = 5), 1 == v ? (ue(), vjs_addClass(vjs_find(r, ".vjs-zoom-parent"), "vjs-hidden"), vjs_remClass(_, "vjs-hidden")) : (vjs_remClass(vjs_find(r, ".vjs-zoom-parent"), "vjs-hidden"), je(s, v), vjs_addClass(_, "vjs-hidden"));
                                        ...
                                        J.addEventListener("mousewheel", _e, !1), J.addEventListener("DOMMouseScroll", _e, !1)
                                    }
                                    ...
                                    function ye(e) {
                                        if (v > 1) {
                                            ...
                                            J.style.pointerEvents = "none", document.addEventListener("mouseup", Ce, !0), document.addEventListener("mousemove", be, !0), document.addEventListener("touchend", Ce, !0), document.addEventListener("touchmove", be, !0)
                                        }
                                    }
                                    ...
                                    function Ce(e) {
                                        J.style.pointerEvents = "auto", K = !1, document.removeEventListener("mouseup", Ce, !0), document.removeEventListener("mousemove", be, !0), document.removeEventListener("touchend", Ce, !0), document.removeEventListener("touchmove", be, !0), e.preventDefault(), e.stopPropagation()
                                    }
                                    ...
                                    function Ae(s, i) {
                                        ...
                                        if (0 != n) {
                                            ...
                                            v = d;
                                            t.id();
                                            je(vjs_find(r, ".vjs-tech"), d), se(100 * d), d > 1 ? (e.options.blockKeys = !0, vjs_remClass(vjs_find(r, ".vjs-zoom-parent"), "vjs-hidden"), vjs_addClass(_, "vjs-hidden")) : (ue(), e.options.blockKeys = !1, vjs_addClass(vjs_find(r, ".vjs-zoom-parent"), "vjs-hidden"), vjs_remClass(_, "vjs-hidden"))
                                        }
                                    }
                                    J.addEventListener("mousedown", ye, !0), J.addEventListener("touchstart", ye, !0), vjs_find(r, ".vjs-zoom-slider").addEventListener("click", function(e) {
                                        e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation()
                                    }, !1), vjs_find(r, ".vjs-zoom-slider").addEventListener(setEvent("mousedown"), function(e) {
                                        e.preventDefault(), e.stopImmediatePropagation(), pe();
                                        var t = vjs_find(r, ".vjs-zoom-slider");
                                        Ae(e, t);
                                        var s = function(e) {
                                                e.preventDefault(), e.stopPropagation(), Ae(e, t)
                                            },
                                            i = function(e) {
                                                e.preventDefault(), e.stopPropagation(), me(), document.removeEventListener(setEvent("mouseup"), i), document.removeEventListener(setEvent("mousemove"), s)
                                            };
            ...
            var J = i.getAttribute("poster"),
                G = vjs_El("div", "vjs-lcn");
            if (r.innerHTML = "", G.innerHTML = "deretsiger ton tcudorP".split("").reverse().join(""), J) {
                var V = vjs_El("img", "vjs-lcn-poster");
                V.src = J, r.appendChild(V)
            }
            r.appendChild(G)
        }
        ...
        function ie() {
            ...
            var o = vjs_find(r, ".vjs-settings-div"),
                ...
                h = vjs_find(r, ".vjs-menu-quality");
            if (d) {
                t = vjs_find(r, ".vjs-extend-speed");
                var f = function(e) {
                    e.preventDefault(), e.stopPropagation(), vjs_addClass(u, "vjs-hidden"), vjs_remClass(d, "vjs-hidden"), c && vjs_addClass(c, "vjs-hidden"), h && vjs_addClass(h, "vjs-hidden"), o.style.width = n.speedMenu.width + "px", o.style.height = n.speedMenu.height + "px", te(n.speedMenu.height)
                };
                t.onclick = function(e) {
                    f(e)
                }, t.ontouchstart = function(e) {
            ...
            if (h) {
                ...
                var m = function(e) {
                    ...
                    vjs_addClass(u, "vjs-hidden"), vjs_remClass(h, "vjs-hidden"), d && vjs_addClass(d, "vjs-hidden"), c && vjs_addClass(c, "vjs-hidden");
                    vjs_find(r, ".vjs-qua-list");
                ...
                var g = vjs_find(h, ".vjs-quality-back");
                if (g) {
                    var y = function(e) {
            ...
            if (c) {
                ...
                var b = function(e) {
                    e.preventDefault(), e.stopPropagation(), vjs_addClass(u, "vjs-hidden"), vjs_remClass(c, "vjs-hidden"), d && vjs_addClass(d, "vjs-hidden"), h && vjs_addClass(h, "vjs-hidden"), o.style.width = n.zoomMenu.width + "px", o.style.height = n.zoomMenu.height + "px";
                    var t = (v - 1) / 4 * 100;
            ...
            var x = vjs_find(r, ".vjs-cog-menu-button"),
                k = function(e) {
            ...
            a.qualityMenu && 1 != a.shareMenu && 1 != a.relatedMenu && 1 != a.zoomMenu && 1 != a.speedMenu && (vjs_remClass(x, "vjs-hidden"), vjs_find(r, ".vjs-menu-forward span").style.paddingLeft = "40px");
            E.onclick = function(e) {
                k(e)
            }, E.ontouchstart = function(e) {
                k(e)
        ...
        function ne() {
            ...
            if (vjs_find(r, ".rel-block")) {
                ...
                var u = 3,
                    h = 2;
                t < 5 && 3 != t && (u = 2), t < 4 && (h = 1), l < 480 && (u = 2, h = 1);
                var f = l / u * .5625,
                    j = l / u,
                    p = Math.ceil(t / 6);
                o > p && (o = p), d = p, 2 == u && 2 == h && (d = Math.ceil(t / 4)), 2 == u && 1 == h && (d = Math.ceil(t / 2)), c.style.height = f * h + "px";
                var m = i / 2 - l / 2;
                if (c.style.top = n / 2 - f * h / 2 + "px", c.style.left = i / 2 - l / 2 + "px", 1 != e.browser.TOUCH_ENABLED) {
                ...
                for (var A = 0, x = 0, k = r.querySelectorAll(".rel-parent"), w = 0; w < k.length; w++) {
                    var T = k[w];
                    T.style.left = A + "px", 1 == x && h > 1 ? (T.style.top = f + "px", A += j) : T.style.top = 0, 1 == h && (A += j), T.style.width = j + "px", T.style.height = f + "px", h > 1 ? 2 == ++x && (x = 0) : x = 0
                }
        ...
        function le(e, t) {
            ...
            if (a.hdicon) {
                var l = "HD";
                s > 2159 && (l = "4K"), s > 719 && (n = '<i class="vjs-hd-icon vjs-hd-home">' + l + "</i>", i = '<i class="vjs-hd-icon vjs-hd-menu">' + l + "</i>")
            }
            a.qualityMenu ? vjs_find(r, ".vjs-extend-quality span").innerHTML = t + i : (vjs_find(r, ".vjs-cog-menu-button").innerHTML, vjs_find(r, ".vjs-quality-button span").innerHTML = t + n)
        }
        ...
        function de() {
            ...
            if (t.textTracks().length > 0) {
                ...
                for (var i = 0; i < e.length; i++) {
                    var n = new Object;
                    plTrack = e.tracks_[i], "captions" == plTrack.kind && (n.src = plTrack.src, n.language = plTrack.language, n.label = plTrack.label, "showing" == plTrack.mode && (n.mode = "showing"), s.push(n))
                }
            }
            t.captions = s
        }
                ...
                v.src = a.slideImage, v.onload = function() {
                    ...
                    vjs_find(r, ".vjs-progress-holder").onmousemove = function(s) {
                        vjs_find(r, ".vjs-tech-chromecast") || vjs_find(r, ".vjs-progress-slide") && function(s) {
                            ...
                            var h = Number(v) / Number(i),
                                f = e.options.skinname,
                            ...
                            "treso" == f && (y += p), v < _ && (v = _), v > y && (v = y), "party" == f && (v += 10), n.style.left = v + "px", l.style.opacity = 1, l.style.MozOpacity = 1, l.style.filter = "alpha(opacity=100)"
                        }()
        ...
        function ue() {
            he(), v = 1, vjs_remClass(_, "vjs-hidden"), vjs_find(r, ".vjs-poster").setAttribute("style", "display:inline-block");
            try {
                vjs_find(r, ".vjs-zoom-level").style.height = "0"
            } catch (e) {}
            var t = vjs_find(r, ".vjs-tech");
            je(t, 1), t.style.top = 0, t.style.left = 0;
        ...
        function je(e, t) {
            he(), e.style.transform = "scale(" + t + ")", e.style.transform = "scale(" + t + ")", e.style.webkitTransform = "scale(" + t + ")", e.style.mozTransform = "scale(" + t + ")", e.style.msTransform = "scale(" + t + ")", e.style.oTransform = "scale(" + t + ")"
        }
    ...
    document.body.removeChild(t), e.browser.IS_ANDROID && (e.options.hls.overrideNative = !0, e.options.html5.nativeAudioTracks = !1, e.options.html5.nativeTextTracks = !1);
    var a = function(e) {
        this.ready(function() {
            n(this, e)
        })
...
function(e, t) {
    ...
    var t = !1,
        ...
        n = function(e, s) {
            ...
            return s.playlistItemId_ && (e.playlist.currentPlaylistItemId_ = s.playlistItemId_), e.changeSrc(s), 1 != t ? t = !0 : e.trigger("playlist_change"), e.ready(function() {
                if (e.trigger("playlistitem", s.originalValue || s), e.trigger("playlist_newitem", {
        ...
        this.ready(function() {
            ! function(t, v, c) {
                    ...
                    f = t.playlist = function(e, s) {
                        ...
                        if (Array.isArray(e)) {
                            ...
                            (u = n.slice()).filter(function(e) {
                                return a(e)
                            }).length !== u.length && (u = r(u)), l(u), h = !0, t.trigger({
                                previousPlaylist: i || []
                            }), h = !1, -1 !== s && f.currentItem(s), i && t.setTimeout(function() {
                ...
                t.on("loadstart", function() {
                    -1 === f.currentItem() && s(t)
                }), f.currentIndex_ = -1, f.player_ = t, f.autoadvance_ = {}, f.repeat_ = !1, f.currentPlaylistItemId_ = null, f.currentItem = function(e) {
                    if (h) return f.currentIndex_;
                    if ("number" == typeof e && f.currentIndex_ !== e && e >= 0 && e < u.length) return f.currentIndex_ = e, n(f.player_, u[f.currentIndex_]), f.currentIndex_;
                    var t = f.player_.currentSrc() || "";
                    if (f.currentPlaylistItemId_) {
                        var s = o(u, f.currentPlaylistItemId_),
                            i = u[s];
                        if (i && Array.isArray(i.sources) && d([i], t) > -1) return f.currentIndex_ = s, f.currentIndex_;
                        f.currentPlaylistItemId_ = null
                    }
                    return f.currentIndex_ = f.indexOf(t), f.currentIndex_
                ...
                }, f.lastIndex = function() {
                    return u.length - 1
                }, f.nextIndex = function() {
                    var e = f.currentItem();
                    if (-1 === e) return -1;
                    var t = f.lastIndex();
                    return f.repeat_ && e === t ? 0 : Math.min(e + 1, t)
                }, f.previousIndex = function() {
                    var e = f.currentItem();
                    return -1 === e ? -1 : f.repeat_ && 0 === e ? f.lastIndex() : Math.max(e - 1, 0)
                }, f.first = function() {
                    if (!h) {
                        var e = f.currentItem(0);
                        if (u.length) return u[e].originalValue || u[e];
                        f.currentIndex_ = -1
                    }
                }, f.last = function() {
                    if (!h) {
                        var e = f.currentItem(f.lastIndex());
                        if (u.length) return u[e].originalValue || u[e];
                        f.currentIndex_ = -1
                    }
                }, f.next = function() {
                    if (!h) {
                        var e = f.nextIndex();
                        if (e !== f.currentIndex_) {
                            var t = f.currentItem(e);
                            return u[t].originalValue || u[t]
                        }
                    }
                }, f.previous = function() {
                    if (!h) {
                        var e = f.previousIndex();
                        if (e !== f.currentIndex_) {
                            var t = f.currentItem(e);
                            return u[t].originalValue || u[t]
                        }
                    }
                }, f.autoadvance = function(e) {
                    i(f.player_, e)
                }, f.repeat = function(t) {
                    return void 0 === t ? f.repeat_ : "boolean" == typeof t ? (f.repeat_ = !!t, f.repeat_) : void e.log.error("videojs-playlist: Invalid value for repeat", t)
                }, f.list = function() {
                    return u
                }, f.sort = function(e) {
                    u.length && u.sort(e)
                }, Array.isArray(v) ? f(v.slice(), c) : u = []
