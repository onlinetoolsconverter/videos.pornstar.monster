...
if(isset($_GET['slug'])){ 
  ...
  $json_data = file_get_contents("json_data/$slug.json");
...
<div class="container">
        ...
        <div class="form-group">
            ...
            <textarea id="description" rows="5" required><?php echo $description; ?></textarea>
		...
		<div class="form-group">
            ...
            <input type="text" id="tags" rows="5" value="<?php echo $tags; ?>" required>
        </div>
